// File Name:       day_09/part_1.cpp
// Author:          Samuel Wang (@samuelpswang)
// Purpose:         AoC 2023 Day 9 Part 1 (https://adventofcode.com/2023/day/9)
...
long predict(const vector<long>& f) {
